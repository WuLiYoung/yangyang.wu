...
{
    public class GT_LEDController : IModule
    {
        static public Engine m_TestEngine;
        public static  LEDController  m_object;
        ...
        public GT_LEDController()
        {
            m_object = new LEDController();
        }
        ...
        public int RegisterModule(object sender, object arg)
        {
            for (int i = 0; i < m_TestEngine.GetEngineCore(null); i++)
            {
                ...
                l["LEDController"] = m_object;
                se.DoString("llc= require \"LEDControllers\"");
            }
            return 0;
        }
        ...
        int OnUiLoadFinish(Notification nf)
        {
            ...
            instr.DropDownItems.Add("ALSC3-1 Config", null, new EventHandler(OnMCUConfig));
