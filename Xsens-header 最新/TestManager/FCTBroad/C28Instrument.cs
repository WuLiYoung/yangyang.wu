...
{
    public class C28Instrument : SerialPort
    {
        ...
        public C28Instrument()
        {

        }
        public C28Instrument(int nuutid)
        {
            m_UUTID = nuutid;
        }
        ...
        public void Init()
        {
            ...
            try
            {
                //if (GT_C28Instrument.mConfigInfo.ContainsKey(MakeConfigString(fctMarcro.kFCTConfig, m_UUTID)))
                //    this.Setting = GT_C28Instrument.mConfigInfo[MakeConfigString(fctMarcro.kFCTConfig, m_UUTID)].ToString();
                //else
                //{
                //    this.Setting = "115200,N,8,1";
                //    GT_C28Instrument.mConfigInfo[fctMarcro.kFCTConfig] = Setting;
                //}
                    this.Setting = "115200,N,8,1";
                    GT_C28Instrument.mConfigInfo[fctMarcro.kFCTConfig] = Setting;
                

                if (GT_C28Instrument.mConfigInfo[MakeConfigString(fctMarcro.kFCTCom, m_UUTID)] != null)
                    PortName = GT_C28Instrument.mConfigInfo[
        ...
        {
            GT_C28Instrument.mConfigInfo[fctMarcro.kFCTCom] = com;
            if (config.Length > 0)
        ...
        public int WaitDetect(int iTimeOut)
        {
            ...
            {
                if (GT_C28Instrument.m_TestEngine.m_testStop)
                {
                    return -1;
                }
