...
namespace UserInterface
{
    public partial class frmTestState : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void UpdatePassFailRate()
        {
            ...
            File.WriteAllText("C:\\1.txt", tmGlobalobj.PassCount.ToString()+","+ tmGlobalobj.Failcount.ToString()+","+textBoxPassRate.Text+","+ textBoxFailRate.Text);
        }
        ...
        private void bnReset_Click(object sender, EventArgs e)
        {
            ...
            txtFail.Text = "0";
            txtPass.Text = "0";
            textBoxPassRate.Text = "0.0000%";
            textBoxFailRate.Text = "0.0000%";
        }
        ...
        {
            if (log.txtLog.Text != null)
            {
                log.txtLog.Clear();
                log.txtLog.Text = string.Empty;
            }
