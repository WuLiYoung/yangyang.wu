...
namespace UserInterface
{
    public partial class MainForm : Form
    {
       ...
       // public TestUnit unit = new TestUnit();
        TestUnit UUT0;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            NotificationCenter.DefaultCenter().AddObserver(tmMarcos.kOnShowBarCodeScan, OnShowBarCodeScan);
            NotificationCenter.DefaultCenter().AddObserver(tmMarcos.kOnStartTest, OnStartTest);
        }
        ...
        public int OnShowBarCodeScan(Notification nf)
        {
            ShowBarCodeScan();
            return 0;
        }
