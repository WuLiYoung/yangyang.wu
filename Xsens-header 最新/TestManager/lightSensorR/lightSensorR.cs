...
{
    public class lightSensorR:SerialPort
    {
        ...
        public void Init()
        {
            ...
            try
            {
                if (GT_lightSensorR.mConfigInfo.ContainsKey(tmMarcos.kSensor2Config))
                    this.Setting = GT_lightSensorR.mConfigInfo[tmMarcos.kSensor2Config].ToString();
                else
                {
                    this.Setting = "115200,N,8,1";
                    GT_lightSensorR.mConfigInfo[tmMarcos.kSensor2Config] = Setting;
                }
                if (GT_lightSensorR.mConfigInfo[tmMarcos.kSensor2Com] != null)
                    PortName = GT_lightSensorR.mConfigInfo[tmMarcos.kSensor2Com].ToString();
            }
            catch (Exception)
            {
            }
        ...
        private void OnReceive(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            Console.WriteLine(System.Text.Encoding.ASCII.GetString(m_Buffer.ToArray()));
        ...
        public void CheckAndConnect()
        {
            ...
            {
                NotificationCenter.DefaultCenter().Notification2Statue(0, "Sensor 2 打开失败" + ex.Message + "(E0007)");
            }
        }
        ...
        public void DoConnect()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("打开Sensor 2 失败 " + e.Message + "(E0007)");
            }
        }
    }
}
